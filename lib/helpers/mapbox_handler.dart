...
Future<List> getParsedResponseForQuery(String value) async {
  ...
  var response = Map<String, dynamic>.from(await getSearchResultsFromQueryUsingMapbox(query));
...
Future<Map> getParsedReverseGeocoding(LatLng latLng) async {
  var response =
      Map<String, dynamic>.from(await getReverseGeocodingGivenLatLngUsingMapbox(latLng));
